...
/**
 * Modal dialog for managing the reaperVideo effect library.
 * Mirrors JsEffectLibraryDialog in structure; reuses the `.pn-jslib-*` CSS
 * so the visual is identical.
 */
export class ReaperVideoLibraryDialog {
  ...
  private buildOverlay(): HTMLDivElement {
    ...
    title.textContent = "reaperVideo effect library";
